...
var config = {
    "huobi": {
        "access_key": "a58fecc6-623755e1-515f8a7a-0975e",
        "secretkey": "59fbe437-ce1841e8-7fd53bbf-ce561",
        "account_id": "replace_me",
        "account_id_pro": "replace_me",
...
var HUOBI_PRO = {
    ...
    withdrawal: function(address, coin, amount, payment_id) {
        ...
        return call_api('POST', path, payload, body);
    },get_market_detail: function(symbol) {
        var path = `/market/detail`;
        var body = get_body();
        body.symbol = symbol;
        // body.states = 'submitted,partial-filled';
        var payload = sign_sha('GET', URL_HUOBI_PRO, path, body);
